...
INSERT INTO `buddy_request` VALUES (988257,3187,'pending','2023-03-14 21:00:00');
...
CREATE TABLE `extension_application` (
  ...
  `application_status` enum('pending','submit','success','approved','declined','collecting') NOT NULL,
  PRIMARY KEY (`id`),
  KEY `student_id` (`student_id`),
...
INSERT INTO `roles` VALUES (1,'admin'),(2,'super_admin'),(3,'student');
...
INSERT INTO `student_details` VALUES (6,3187,'0718744632','FIT','BBIT','congolese','poooidj9','2023-03-10','passport.jpg','Qwetu'),(7,31878,'0718744632','FIT','BBIT','congolese','poooidj9','2023-03-10','passport.jpg','Qwetu');
...
INSERT INTO `student_guardian` VALUES (4,3187,'Mee','givenshr8@gmail.com','0718744632','primary'),(5,31878,'Mee','givenshr8@gmail.com','0718744632','primary');
...
INSERT INTO `user_roles` VALUES (1,3187,'student');
...
INSERT INTO `user_verification` VALUES (3,3187,0,'2023-03-10 05:00:00','','2023-03-10 05:00:00','2023-03-10 05:00:00'),(4,31878,0,'2023-03-10 05:00:00','','2023-03-10 05:00:00','2023-03-10 05:00:00');
...
INSERT INTO `users` VALUES (3187,'Masheka','Given Masheka','givenshr8@gmail.com','$2y$10$5OQCbRRqhOaIidZVbX7UNuUfH554N6FUaJvpvEwh1qVl5naQCrea.',NULL,0),(31878,'Masheka','Given Ishara','9givenshr8@gmail.com','123456',NULL,0);
...
/*!50001 VIEW `student_view_data` AS select `users`.`id` AS `student_id`,`users`.`surname` AS `surname`,`users`.`other_names` AS `other_names`,`users`.`email` AS `email`,`student_details`.`phone_number` AS `phone_number`,`student_details`.`faculty` AS `faculty`,`student_details`.`course` AS `course`,`student_details`.`nationality` AS `nationality`,`student_details`.`passport_number` AS `passport_number`,`student_details`.`passport_expire_date` AS `passport_expire_date`,`student_details`.`residence` AS `residence` from (`users` join `student_details`) where (`student_details`.`student_id` = `users`.`id`) */;
...
-- Dump completed on 2023-03-15 20:47:55

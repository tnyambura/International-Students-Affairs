...
CREATE TABLE `bookingList` (
  ...
  CONSTRAINT `bookinglist_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`)
...
INSERT INTO `bookingList` VALUES (1,66753,11111,'[\"2023_April_3\",[]]','pending'),(2,66753,11111,'[\"2023_April_21\",[]]','pending'),(3,66753,11111,'[\"2023_April_17\",[]]','pending'),(4,66753,11111,'[\"2023_April_6\",[]]','pending');
...
) ENGINE=InnoDB AUTO_INCREMENT=908658 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `buddies_allocations` VALUES (701062,564443,11111,22122,NULL);
...
INSERT INTO `buddy_request` VALUES (564443,11111,'approved','2023-03-02 21:00:00'),(845188,45665,'pending','2023-04-05 19:02:25');
...
INSERT INTO `extension_application` VALUES (470496,11111,'11111_PassportBioData_470496.pdf','11111_entryPage_470496.png','11111_CurrentVisa_470496.png','2023-03-19','2023-03-16 00:00:00','pending',NULL),(476145,11111,'11111_PassportBioData_476145.png','11111_entryPage_476145.png','11111_CurrentVisa_476145.png','2023-03-19','2023-03-16 00:00:00','declined',NULL),(786608,11111,'11111_PassportBioData_786608.png','11111_entryPage_786608.png','11111_CurrentVisa_786608.png','2023-03-19','2023-03-16 00:00:00','declined',NULL),(808202,11111,'11111_PassportBioData_808202.png','11111_entryPage_808202.png','11111_CurrentVisa_808202.png','2023-03-19','2023-03-16 00:00:00','declined',NULL);
...
INSERT INTO `kpps_application` VALUES (100656,11111,'11111_PassportPhoto.png','11111_PassportBioData.png','11111_CurrentVisa.png','11111_GuardianBio.png','11111_CommitmentLetter.png','11111_AcademicTranscript.png','11111_PoliceClearance.png','2023-04-06 12:29:08','pending',NULL),(217952,11111,'11111_PassportPhoto.png','11111_PassportBioData.png','11111_CurrentVisa.png','11111_GuardianBio.png','11111_CommitmentLetter.png','11111_AcademicTranscript.png','11111_PoliceClearance.png','2023-04-05 21:44:16','declined',NULL),(258197,11111,'11111_PassportPhoto.png','11111_PassportBioData.png','11111_CurrentVisa.png','11111_GuardianBio.png','11111_CommitmentLetter.png','11111_AcademicTranscript.png','11111_PoliceClearance.png','2023-04-04 00:29:48','approved','66753_StudentPassDoc258197.png');
...
INSERT INTO `scheduleTime` VALUES (1,66753,'[[\"2023_April_17\",[\"9am\",\"12pm\",\"3pm\"]],[\"2023_April_6\",[]]]');
...
INSERT INTO `user_roles` VALUES (29,66753,'super_admin'),(30,101618,'student'),(31,11111,'student'),(32,4444,'student'),(33,45665,'student'),(37,44321,'admin'),(41,4444,'admin'),(42,22122,'student'),(43,22122,'buddy');
...
-- Dump completed on 2023-04-12 13:09:35

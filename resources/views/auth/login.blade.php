  ...
  <div class=" mx-4 shadow-5-strong align-items-center justify-content-center" style="
    ...
    <div class="col-lg w-100 justify-content-center align-items-center position-relative" >
          ...
          @foreach($GuideData as $data)
            @foreach($data as $items)
              <div class='row align-items-center'>
                  @foreach($items as $v)
                    <a class='col-lg ml-3 mb-2 d-flex ' href="/downloadGuides/{{Crypt::encrypt($v['file_name'])}}"><i class='fa fa-file-pdf mr-2' style='font-size: 30px; color:var(--danger); height: 50px;'></i><span style='font-size:12px; color: #113C7A; align-self:center;'>{{explode('.',$v['file_name'])[0]}}</span></a><br/>
                  @endforeach
                </div>
                @endforeach
            @endforeach
      ...
      <div class=" mb-3">
        ...
        <a href="https://susa.strathmore.edu/our-services/international-students/" class="btn btn-link btn-floating mx-1 my-2">
          About Us
        </a>
        <a href="/forgotpassword" class="btn btn-link btn-floating mx-1 my-2">
            Forgot Password
        </a>
        <a href="https://su-sso.strathmore.edu/susams/servlet/edu/strathmore/ams/susams/Init.html" class="btn btn-link btn-floating mx-1 my-2">
            AMS
        </a>
        <a href="https://elearning.strathmore.edu/login/index.php" class="btn btn-link btn-floating mx-1 my-2">
            E-learning
        </a>

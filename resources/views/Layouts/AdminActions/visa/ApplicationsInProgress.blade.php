                                ...
                                @csrf
                                    <div class='d-flex'>
                                        ...
                                        <div class='d-flex flex-column'>
                                            <label class='btn label-file-change' for="file_upload">
                                                <span>Upload File</span>
                                                <input type="file" onchange='FileChanged(event)' class='d-none' id='file_upload' name='fileResponse'/>
                                            </label>
                                        </div>
                                    </div>
...
@section('subtabs_content')
    <div class="card subTab-Content mb-4 active " id='in_progress_visas'>

            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid"><br/>
                        <ol class="breadcrumb mb-4" style="background:#286DE7;">
                            <li class="breadcrumb-item active" style="color:white;">Buddy Allocation Page</li>
                        </ol>   
                        ...
                        <form method="POST" action="/BuddyAllocation" enctype="multipart/form-data" onSubmit="return validate();">
                            @csrf
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name="surNAME" id="Surname" placeholder="" value="{{ $BuddyRequest->surNAME}}"
                                         required>
                                    
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    <label for="othernames">Prenom (Other Names)</label>
                                    <input type="text" class="form-control" name="otherNAMES" id="othernames" placeholder="" value="{{ $BuddyRequest->otherNAMES}}"
                                         required>
                                    
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    <label for="validationServerUsername33">Passport Number</label>
                                    <input type="text" name="passportNUMBER" class="form-control" id="validationServer023" placeholder="PASSPORT NUMBER" value="{{ $BuddyRequest->PassportNumber}}"
                                         required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="number" name="suID" class="form-control" id="admissionNo" placeholder="" value="{{ $BuddyRequest->suID}}" readonly="readonly"/>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    <label for="Course">Course</label>
                                    <input type="text" name="Course" class="form-control" id="course" placeholder="Course of Study" value="{{ $BuddyRequest->course}}"
                                    required>                                    
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    <label for="Nationality">Nationality</label>
                                    <input type="text" name="Nationality" class="form-control" id="Nationality" placeholder="Nationality" value="{{ $BuddyRequest->Nationality}}"
                                    required>                                    
                                    </div>
                                </div>                                   
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="suEMAIL" class="form-control" id="email" placeholder="" value="{{ $BuddyRequest->email}}" 
                                            required>
                                    </div>
                                   
                                     <div class="col-md-6 mb-3">
                                        <label for="Faculty">Faculty</label>
                                        <input type="text" name="Faculty" class="form-control" id="Faculty" value="{{ $BuddyRequest->Faculty}}"placeholder="Faculty"
                                            required>
                                        </div>                                     
                                </div><br/>
                                <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <label>Select A Buddy to Allocate<span style="color:red;">*</span></label>
                                    <select name="BuddyName" id="BuddyName" class="form-control" required>
                                        <option></option>
                                    <?php
                                    foreach($get_Buddydata as $data){
                                          ?>
                                    <option value="{{$data->id}}">{{$data->suID}}</option>
                                    <?php
                                    }
                                    ?>
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                    <label>Select A Buddy SUID<span style="color:red;">*</span></label>
                                    <select name="BuddyID" id="BuddyID" class="form-control" required>
                                    <option></option>
                                    <?php
                                    foreach($get_Buddydata as $data){
                                          ?>
                                    <!-- <option value="{{$data->suID}}">{{$data->suID}}</option> -->
                                    <?php
                                    }
                                    ?>
                                    </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <button class="btn btn-primary" id="btnSubmit" type="submit">Allocate</button>
                                </form>  

        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid"><br/>
                        ...
                        @endif
                            <form method="POST" action="/EditstudentDetails/{id}" enctype="multipart/form-data">
                            @csrf
                            <h4>NEW STUDENT REGISTRATION</h4><br/>
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" class="form-control" name ="suEMAIL" id="suEMAIL" value="{{ $data->suEMAIL}}"
                                        required>
                                  </div>
                                ...
                                <div><h4>PARENT DETAILS<h4></div><br/>
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"  name ="ParentPhone" id="ParentPhone" value="{{ $data->ParentPhone}}"
                                        required>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    <label for="ParentNames">Parent Names</label>
                                    <input type="text" class="form-control" id="ParentNames" name ="ParentNames" value="{{ $data->ParentNames}}"
                                         required>
                                    </div>    
                                </div>

                ...
                <nav class="sb-sidenav accordion sb-sidenav " style='background:#113C7A; color:#fff; border:none;' id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-menu d-flex flex-column justify-content-between pt-4">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{ route('view.manageFiles')}}">
                                <div class="sb-nav-link-icon"><i class="far fa-folder-open"></i></div>
                                Manage Files
                            </a>   
                            <a class="nav-link" href="{{ route('view.buddymanage')}}">
                            ...
                            <a class="nav-link" href="{{ route('view.schedule')}}">
                                <div class="sb-nav-link-icon"><i class="far fa-calendar-times"></i></div>
                                My Schedule
                            </a>                        
                            <a class="nav-link" href="{{ route('view.newuser')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-plus"></i></div>
                                Add New User
                            </a>
                            <a class="nav-link" href="{{ route('view.allusers')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                                List of all Users
                            </a>
                             <!-- Add a student list controller and view page-->
                             <a class="nav-link" href="{{ route('view.visa',['type'=>'kpps','status'=>'request'])}}">
                                ...
                                <div class='pass-change-form mb-3'>
                                    ...
                                    <div class="row  d-flex justify-content-between">
                                        ...
                                        <div class='col'>
                                            ...
                                            <input type="password" pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" name="new_pass" id="newpassInput" disabled>
                                        </div>
                                        <div class='col'>

    ...
    <div class="container-fluid"><br/>
            <ol class="breadcrumb mb-4 d-flex align-items-center" style="background: #113C7A;">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label m-0" for="new_staff">A New Staff</label>
                </div>
                </li>
            </ol> 
            ...
            <form method="POST" action="{{ route('add.newuser') }}" class='new-staff-form'>
                ...
                <div class='d-flex justify-content-center align-items-center'>
                    <input class="btn mt-3 w-75" style='margin-inline:center; border: 2px solid rgb(17,60,122); color:rgb(17,60,122); font-weight: bold' value="Add Staff" type="submit" />
                </div>
            </form><br/>
            ...
            <ol class="breadcrumb mb-4" style="background: #113C7A;">
                <li class="breadcrumb-item active" style="color:white;">
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label m-0" for="new_student">A New Student</label>
                    </div>
                </li>
            </ol> 
            ...
            <form method="POST"  class='new-student-form' action="{{route('Add.signup')}}">
                ...
                <x-auth-validation-errors class="mb-4" :errors="$errors" />
                    ...
                    <div class='p-3 my-4 rounded' style='background: rgb(17,60,122,.3)'>
                        <h4>PARENTS DETAIL</h4>
                        <div class="form-check d-flex align-items-center" role='button'>
                    ...
                    <div class='d-flex justify-content-center align-items-center'>
                        <input class="btn mt-3 w-75" style='margin-inline:center; border: 2px solid rgb(17,60,122); color:rgb(17,60,122); font-weight: bold' value="Add Student" type="submit" />
                    </div>
            </form>
            <script>

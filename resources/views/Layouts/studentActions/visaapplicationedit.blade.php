            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid"><br/>
                        <ol class="breadcrumb mb-4" style="background:#286DE7;">
                            <li class="breadcrumb-item active" style="color:white;">Kenyan visitors pass Application Request Edit Page</li>
                        </ol> 
                        ...
                        @endif
                        @if(Session::has('visa_notupdated_successfully'))
                        <div class="alert alert-danger" role="alert">
                        {{Session::get('visa_notupdated_successfully')}}
                        </div>
                        @endif
                            <form method="POST" action="/MyvisaAppEDIT/{id}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <h4>BIODATA SECTION</h4><br/>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                    <label for="Current Visa">Upload a clear copy of your Current Visa</label>
                                    <input type="file" name="currentVISA" class="form-control" id="currentVISA" value="{{ $data->currentVISA}}"
                                    required  >                                    
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                    <label for="ParentBiodata">Upload a clear copy of your entry Visa</label>
                                    <input type="file" name="entryVISA" class="form-control" id="entryV" value="{{ $data->entryVISA}}"
                                    required  >
                                  </div>                                

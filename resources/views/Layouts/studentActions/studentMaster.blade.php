...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('asset/img/isa_logo.png')}}">
        <link href="{{asset('asset/css/styles.css')}}" rel="stylesheet"/>
        <link href="{{asset('asset/css/progress.css')}}" rel="stylesheet"/>
        <!-- <link href="{{asset('asset/css/custom_select.css')}}" rel="stylesheet"/> -->
                ...
                <nav class="sb-sidenav accordion sb-sidenav" style='background:#113C7A; color:#fff; border:none;' id="sidenavAccordion">
                    <div class="d-flex flex-column mt-6">
                        <div class="dropbtn d-flex align-self-center justify-content-center mx-2" style="border:1px solid rgba(180,180,180); width:80px; height:80px; border-radius:50%; object-fit:contain; overflow:hidden;" role="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img style="width:100%;" src="{{asset('asset/img/isa_logo.png')}}" />
                        </div>
                    ...
                    <div class="sb-sidenav-menu d-flex flex-column justify-content-between">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{ route('view.mykpp')}}">
                                <div class="sb-nav-link-icon"><i class="far fa-address-card"></i></div>
                                My Student Pass
                                @if($NoKpps > 0)
                                    <span class="nokpp-badge badge badge-warning ml-2">{{$NoKpps}}</span>
                                @endif
                            </a>
                            <a class="nav-link" href="{{ route('view.myextension')}}">
                                <div class="sb-nav-link-icon"><i class="material-icons" style='font-size:.9rem'>extension</i></div>
                                My Extension
                                @if($NoExt > 0)
                                    <span class="noext-badge badge badge-warning ml-2">{{$NoExt}}</span>
                                @endif
                            </a>
                            <a class="nav-link" href="{{ route('view.buddyprogram')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-clipboard-list"></i></div>
                                Buddy Program
                            </a> 
                            <!-- Add a student list controller and view page-->
                            <a class="nav-link" href="{{ route('view.newkpp')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-marker"></i></div>
                                Initiate a student pass
                            </a>
                            <a class="nav-link" href="{{ route('view.newextension')}}">
                                <div class="sb-nav-link-icon"><i class="fas fa-marker"></i></div>
                                Initiate an Extension
                            </a>
                            
                            <div class="nav-link bookBtn" role='button' data-toggle="modal" data-target="#BookMeeting_{{Auth::user()->id}}">
                        ...
                        <a class="sb-sidenav-footer bg-danger out w-100" style='color:white' href="{{ route('act.logout')}}">Logout</a>
                    </div>
                </nav>
            </div>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            @endif
                                ...
                                <div class='pass-change-form'>
                                    <div class="pass-message-display " style="border-radius:10px;">
                                        <ul >
                                    ...
                                    <div class="form-group  d-flex justify-content-between">
                                        ...
                                        <div class='col'>
                                            ...
                                            <input type="password" class="form-control" name="new_pass" id="newpassInput" disabled>
                                        </div>
                                        <div class='col'>
                        ...
                        <div class="card-body">
                            ...
                            <div class='container'>
                                <form action="{{route('add.bookMeeting')}}" method="post"> @csrf
                                    ...
                                    <input type="hidden" name="selected_date_data" id='selected_date_data' required>

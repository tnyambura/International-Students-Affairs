...
@section('content')   
                <div class="container-fluid"><br/>
                        <ol class="breadcrumb mb-4" style="background:#286DE7;">
                            <li class="breadcrumb-item active" style="color:white;">New User Enrollment Portal</li>
                        </ol>   
                        ...
                        <form method="POST" action="{{ __('EnrollNewUser') }}">
                            @csrf
                            ...
                            <label for="suID">suID</label>  
                                <Input id="suID" class="form-control" type="text" name="suID" required autofocus />
                            </div></br>

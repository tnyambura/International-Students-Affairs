...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2022 at 09:55 AM
...
(1, 'Approved', 'Oloo', 'Isaya Ogumbe', 'ab72617sb', 'Iloo@gmail.com', '09000', 'Bahamas', '2021-09-13', '1632735344.bate approval.pdf', '1632735344.BuddyAllocations (1).pdf', '1632735344.BuddyAllocations (2).pdf', '1632735344.chanda approval.pdf', '2021-09-27 06:35:44', '2021-11-16 05:45:06'),
(2, 'Approved', 'Surname', 'Othernames', 'AB2365789WW', 'suenamr@strathmore.edu', '7000', 'U.S. Virgin Islands', '2021-11-18', '1637052369.Form30 (1).pdf', '1637052369.Form30 (3).pdf', '1637052369.Form30 (6).pdf', '1637052369.Form30.pdf', '2021-11-16 05:46:09', '2021-11-16 05:46:57');
...
CREATE TABLE `apply_kpps` (
  ...
  `dateofENTRY` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phoneNUMBER` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `passportPICTURE` mediumtext COLLATE utf8mb4_unicode_ci,
  `biodataPAGE` mediumtext COLLATE utf8mb4_unicode_ci,
  `currentVISA` mediumtext COLLATE utf8mb4_unicode_ci,
  `guardiansID` mediumtext COLLATE utf8mb4_unicode_ci,
  `commitmentLETTER` mediumtext COLLATE utf8mb4_unicode_ci,
  `academicTRANSCRIPTS` mediumtext COLLATE utf8mb4_unicode_ci,
  `policeCLEARANCE` mediumtext COLLATE utf8mb4_unicode_ci,
  `Faculty` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `apply_kpps`
--

INSERT INTO `apply_kpps` (`id`, `surNAME`, `otherNAMES`, `passportNUMBER`, `suID`, `Course`, `Residence`, `suEMAIL`, `Nationality`, `dateofENTRY`, `phoneNUMBER`, `passportPICTURE`, `biodataPAGE`, `currentVISA`, `guardiansID`, `commitmentLETTER`, `academicTRANSCRIPTS`, `policeCLEARANCE`, `Faculty`, `created_at`, `updated_at`) VALUES
(1, 'Surname', 'Othernames', 'AB2365789WW', '7000', 'BBIT', 'OLES', 'suenamr@strathmore.edu', 'U.S. Virgin Islands', '2021-11-09', '254789054', '1637052226.Form30 (1).pdf', '1637052226.Form30 (2).pdf', '1637052226.Form30 (3).pdf', '1637052226.Form30 (7).pdf', '1637052226.precious approval.pdf', '1637052226.halima mpesa.JPG', '1637052226.precious mpesa.JPG', 'SUBS', '2021-11-16 05:43:46', '2021-11-16 05:43:46');
...
(2, 'Murume', '01587', 'Tukpah', 'Dehcontee', 'AD5372823CB', 'dbm', '113833', 'johnmahinda65@gmail.com', 'sces', NULL, 'Liberia', NULL, '2021-10-06 09:17:59', '2021-10-06 09:17:59');
...
(2, 'Tukpah', 'Dehcontee', '113833', 'johnmahinda65@gmail.com', 'dbm', '1970', 'AD5372823CB', 'Liberia', 'sces', NULL, '2021-10-06 09:13:44', '2021-10-06 09:13:44');
...
('shaddymasha@gmail.com', '$2y$10$mNGkOujpRqvB7YIVI61uVuFy2.16ALmyrR2xv5iW3/1Opvtap3sH.', '2021-11-03 11:04:32');
...
(3, 'Oloo', 'Isaya Ogumbe', '09000', 'shaddymasha@gmail.com', NULL, '$2y$10$p7IyJRwauFpVL9Tr81I3ju1Wm9YPE2uylzEkRNPrOdPHrWzTk3Cha', NULL, '2021-09-27 06:34:51', '2021-09-27 06:34:51'),
(4, 'Tukpah', 'Dehcontee', '113833', 'tpatienced322@gmail.com', NULL, '$2y$10$hYecN70P03NRMFcsydeLyuNGp90lUF7U6qZ67BKyBTK7bl4sJwWWu', NULL, '2021-10-06 09:06:15', '2021-10-06 09:06:15'),
(5, 'Surname', 'Othernames', '7000', 'suenamr@strathmore.edu', NULL, '$2y$10$unj8Nr4b7wHErNmJLdc1reQMeLPVMamjJsFo18BkO/ByGXpGAKF7G', NULL, '2021-11-16 05:41:56', '2021-11-16 05:41:56');
